...
class POSOrder(models.Model):
    ...
    def print_report(self):
        for order in self:
            return order.print_html_report(order.id, 'pos_retail_standard.pos_order_template')
    ...
    def action_pos_order_send(self):
        ...
        self.ensure_one()
        template = self.env.ref('pos_retail_standard.email_template_edi_pos_orders', False)
    ...
    def _payment_fields(self, order, ui_paymentline):
        ...
        if ui_paymentline.get('cheque_DateEcheance', None):
            payment_fields['cheque_DateEcheance'] = ui_paymentline.get('cheque_DateEcheance')
