odoo.define('pos_retail_standard.big_data', function (require) {

    const models = require('point_of_sale.models');
    const core = require('web.core');
    const _t = core._t;
    const db = require('point_of_sale.DB');
    const indexed_db = require('pos_retail_standard.indexedDB');
    const field_utils = require('web.field_utils');
    const time = require('web.time');
    const retail_db = require('pos_retail_standard.database');
