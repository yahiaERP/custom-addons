 ...
 */
odoo.define('pos_retail_standard.order', function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        verifyMinimumPriceOfProduct(lastPrice, priceApplied) {
            if (this.product.minimum_price > 0 && this.product.minimum_price > priceApplied && priceApplied < this.product.get_price()) {
                this.warning_message = this.product.display_name + _t(' have minimum Price is: ') + this.pos.format_currency(this.product.minimum_price) + _t(' . Please set price bigger than or equal this price')
            } else {
        ...
        set_unit_price: async function (price) {
            ...
            if (!this.is_return) {
                this.verifyMinimumPriceOfProduct(this.last_price, this.after_price)
            }
