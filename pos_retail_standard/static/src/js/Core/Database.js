 ...
 */
odoo.define('pos_retail_standard.database', function (require) {
        ...
        for (let i = 0, len = partners.length; i < len; i++) {
           ...
           /*console.log('*******************');
            ...
            if (partner.type == "delivery" ) {
                this.partner_ids.pop(partner.id)
                continue
            }
            console.log('*******************');*/

            if (partner.supplier_rank == 1 ) {
                //console.log('(user - '+partner.supplier_rank);
               // console.log('**********removing supplier_rank*********');
                this.partner_ids.pop(partner.id)
                continue
            }
    ...
    db.include({
        ...
        _force_update_partners(partners) {
            ...
            partners.forEach(p => {
                ...
                p.address = (p.street ? p.street + ', ' : '') +
                    (p.zip ? p.zip + ', ' : '') +
                    (p.city ? p.city + ', ' : '') +
                    (p.state_id ? p.state_id[1] + ', ' : '') +
                    (p.country_id ? p.country_id[1] : '');
