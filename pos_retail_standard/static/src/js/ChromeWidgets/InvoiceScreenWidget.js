odoo.define('pos_retail_standard.InvoiceScreenWidget', function (require) {
    'use strict';
    ...
    class InvoiceScreenWidget extends PosComponent {
        ...
        mounted() {
            posbus.on('reload-account-move', this, this.render);
        }

        willUnmount() {
            posbus.off('reload-account-move', this, null);
        }
