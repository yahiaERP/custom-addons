odoo.define('pos_retail_standard.PosOrderScreenWidget', function (require) {
    'use strict';
    ...
    class PosOrderScreenWidget extends PosComponent {
        ...
        mounted() {
            posbus.on('reload-pos-orders', this, this.render);
        }

        willUnmount() {
            posbus.off('reload-pos-orders', this, null);
        }
