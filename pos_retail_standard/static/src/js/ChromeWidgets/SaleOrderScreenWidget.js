odoo.define('pos_retail_standard.SaleOrderScreenWidget', function (require) {
    'use strict';
    ...
    class SaleOrderScreenWidget extends PosComponent {
        ...
        mounted() {
            posbus.on('reload-sale-orders', this, this.render);
        }

        willUnmount() {
            posbus.off('reload-sale-orders', this, null);
        }
