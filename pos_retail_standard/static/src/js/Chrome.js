odoo.define('pos_retail_standard.Chrome', function (require) {
    'use strict';
    ...
    const bus = require('pos_retail_standard.core_bus');
    ...
    const RetailChrome = (Chrome) =>
        class extends Chrome {
            ...
            appendLogo() {
                ...
                link.href = '/pos_retail_standard/static/description/icon.ico';
            ...
            async _closePosScreen() {
                ...
                if (!this.env.pos || this.env.pos.db.get_orders().length === 0) {
                    window.location = '/web#action=pos_retail_standard.point_of_sale_portal';
                }
