odoo.define('pos_retail_standard.PopUpSetChequePaymentLine', function (require) {
    'use strict';
    ...
    class PopUpSetChequePaymentLine extends AbstractAwaitablePopup {
        constructor() {
            ...
            if (this.props.cheque_DateEcheance) {
                this.changes['cheque_DateEcheance'] = this.props.cheque_DateEcheance
            }
        ...
        async OnChange(event) {
            ...
            if (!this.changes['cheque_DateEcheance']) {
                this.state.error = this.env._t('Date Echeance  is required')
                return false
            } else {
                this.state.valid = this.env._t('Ready to Save')
                this.state.error = null
