        ...
        class extends ProductsWidgetControlPanel {
            constructor() {
                ...
                this.sepecialFilter.set('all', {
                    key: 'all',
                    text: this.env._t('Tout'),
                })
                this.sepecialFilter.set('out_stock', {
                    key: 'out_stock',
                    text: this.env._t('En rupture de stock'),
                })
                this.sepecialFilter.set('available_stock', {
                    key: 'available_stock',
                    text: this.env._t(' Stock disponible'),
                })
                this.sepecialFilter.set('tracking_lot', {
                    key: 'tracking_lot',
                    text: this.env._t('suivi par lot '),
                })
                ...
                this.sepecialFilter.set('multi_variant', {
                    key: 'multi_variant',
                    text: this.env._t('Multi variante'),
                })
                this.sepecialFilter.set('multi_unit', {
                    key: 'multi_unit',
                    text: this.env._t('plusieurs unité de mesure '),
                })
                this.sepecialFilter.set('multi_barcode', {
                    key: 'multi_barcode',
                    text: this.env._t('Multi code-barres'),
                })
            }
