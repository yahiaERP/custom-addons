odoo.define('pos_retail_standard.ProductScreen', function (require) {
    'use strict';
    ...
    const RetailProductScreen = (ProductScreen) =>
        class extends ProductScreen {
            constructor() {
                ...
                useListener('show-stock', this.redirect_stock);
                useListener('show-devis', this.redirect_devis);
            ...
            async redirect_stock(){
                window.open("http://51.195.169.52:8069/web#cids=1&menu_id=210&action=367&model=stock.picking.type&view_type=kanban",'_blank')  
            }
            async redirect_devis(){
                window.open("http://192.168.100.129:8065/web#cids=1&menu_id=306&action=497&model=sale.order&view_type=list",'_blank')  
            }
