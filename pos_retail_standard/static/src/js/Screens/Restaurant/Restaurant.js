odoo.define('pos_retail_standard.restaurant', function (require) {

    const floors = require('pos_restaurant.floors');
    const {gui} = require('point_of_sale.Gui');
    const {posbus} = require('point_of_sale.utils');
    var sync = require('pos_retail_standard.synchronization');
    var multi_print = require('pos_restaurant.multiprint');
    var rpc = require('pos.rpc');
    var models = require('point_of_sale.models');
    var core = require('web.core');
    var _t = core._t;
    const BigData = require('pos_retail_standard.big_data');
    ...
    models.PosModel = models.PosModel.extend({
        ...
        play_sound: function () {
            var src = "/pos_retail_standard/static/src/sounds/demonstrative.mp3";
