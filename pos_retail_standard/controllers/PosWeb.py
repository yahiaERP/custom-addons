...
class pos_controller(PosController):
    ...
    def publicScanPlacedOrder(self, uid=None, **kk):
        ...
        return request.render('pos_retail_standard.scan_successfully', qcontext={
    ...
    def scanQrOrder(self, order_id='', **k):
        ...
        if len(orders) == 1:
            ...
            response = request.render('pos_retail_standard.qrcode_order', context)
    ...
    def web_login(self, *args, **kw):
        ...
        if request.session.uid:
            ...
            if (pos_config or user.pos_config_ids) and user.pos_portal_user:
                return request.redirect('/web?#action=pos_retail_standard.point_of_sale_portal')
        return response
